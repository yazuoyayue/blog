...
return [
    ...
    'runtimePath' => DOCROOT . '/storage/runtime',
    ...
    'components' => [
        ...
        'user' => [
            ...
            'identityClass' => 'storage\models\User',
            'enableAutoLogin' => '',
     ...
     */
    'as rbac' => [
        'class' => 'storage\behaviors\RbacBehavior',
        'allowActions' => [
            'login/login','login/logout','public*','debug/*','gii/*',// 'user/*', 'test/*'// 不需要权限检测
        ]
    ],
